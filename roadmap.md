...
# Understand the data
One common mistake is when people start to analyse or present their data before they really understand it. You need to understand the scope, granularity and compostion of your source data. This is where some data profiling skills such as summary statistics, means, medians, boxplots can help you to understand it. You may need some domain-specific knowledge to understand how to interpret it.
